...
*/
  const venueTotalCost = venueItems.reduce((total, item) => total + item.cost * item.quantity, 0)
  const avTotalCost = avItems.reduce((total, item) => total + item.cost * item.quantity, 0)
  const mealTotalCost = mealsItems.reduce((total, item) => total + (item.selected ? item.cost : 0) * numberOfPeople, 0)
        ...
        {!showItems
          ...
          (
            ...
            <div className="total_amount_detail">
              <TotalCost totalCosts={totalCosts} handleClick={handleToggleItems} items={items} />
            </div>
          )
        }
